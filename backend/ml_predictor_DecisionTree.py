...
Strategy:
  1. Train DecisionTree models on the dataset to fulfill the ML pipeline.
...
def train_and_save():
    ...
    clf_fa = DecisionTreeClassifier(max_depth=20, min_samples_split=5, random_state=42)
    clf_fa.fit(X_tr, yfa_tr)
    clf_wd = DecisionTreeClassifier(max_depth=20, min_samples_split=5, random_state=42)
